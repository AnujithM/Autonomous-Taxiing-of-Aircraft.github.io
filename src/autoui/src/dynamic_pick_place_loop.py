...
data_,addr_ = UDPServerSocket.recvfrom(1096) #Waiting to receive from MR interface via MR_server
print(data.decode('utf-8'),"... Hence starting!!")
...
rospy.init_node('movebase_client')
db_X = 1.98 #-2.65 #-2.69 #6.17 #2.5 
db_Y = 1.83 #-1.15 #-1.08 #-1.53 #-1.22 #-0.81 
db_th = -1*math.pi/2
